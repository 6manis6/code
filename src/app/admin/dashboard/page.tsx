  ...
  const quickLinks = [
    {
      ...
      icon: FiPlus,
      desc: "List a new item in the store",
    },
    {
      href: "/admin/products",
      label: "Manage Products",
      icon: FiPackage,
      desc: "Edit or delete existing products",
    },
    {
      href: "/admin/orders",
      label: "View Orders",
    ...
    },
    {
      ...
      label: "Edit Banner",
      icon: FiImage,
      desc: "Manage homepage slideshow",
    },
  ];
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-10">
        {statCards.map(({ label, value, icon: Icon, color }) => (
          <div
            key={label}
            className="bg-white dark:bg-dark-card p-4 sm:p-6 rounded-xl shadow flex items-center gap-3 sm:gap-4"
          >
